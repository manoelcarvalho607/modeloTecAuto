...
public class TelaSobre extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("TecAuto_Sobre");
        setPreferredSize(new java.awt.Dimension(417, 322));
        setResizable(false);

        jLabel1.setText("Sistema para controle de Ordem de Serviços");

        jLabel2.setText("Desenvolvido por Sítio - soluções em softwares");

        jLabel3.setText("Sob a licença GPL");

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/tecAuto/img/gnu.png"))); // NOI18N
        ...
        setSize(new java.awt.Dimension(433, 361));
